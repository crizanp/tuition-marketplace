        ...
        <div class="row justify-content-center">
            <div class="col-lg-8">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form action="{{ route('tutor.jobs.update', $job) }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            @method('PUT')
                            ...
                            <div class="row mb-3">
                                <div class="col-12">
                                    ...
                                    <textarea class="form-control @error('description') is-invalid @enderror" 
                                              ...
                                              placeholder="Describe your teaching approach, experience, and what makes you unique...">{{ old('description', $job->description) }}</textarea>
                                    @error('description')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="row mb-3">
                                    ...
                                    <select class="form-select @error('subjects') is-invalid @enderror" 
                                        ...
                                        @foreach($subjects as $subject)
                                            <option value="{{ $subject }}" 
                                                {{ in_array($subject, old('subjects', $job->subjects ?? [])) ? 'selected' : '' }}>
                                                {{ $subject }}
                                            </option>
                                        @endforeach
                                    </select>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="number" class="form-control @error('hourly_rate') is-invalid @enderror" 
                                           id="hourly_rate" name="hourly_rate" value="{{ old('hourly_rate', $job->hourly_rate) }}" 
                            ...
                            <div class="row mb-3">
                                <div class="col-md-6">
                                    ...
                                    <input type="text" class="form-control @error('country') is-invalid @enderror" 
                                           id="country" name="country" value="{{ old('country', $job->country) }}" 
                                           placeholder="Nepal">
                                    @error('country')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="text" class="form-control @error('state') is-invalid @enderror" 
                                           id="state" name="state" value="{{ old('state', $job->state) }}" 
                            ...
                            <div class="row mb-3">
                                <div class="col-md-6">
                                    ...
                                    <input type="text" class="form-control @error('district') is-invalid @enderror" 
                                           id="district" name="district" value="{{ old('district', $job->district) }}" 
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="text" class="form-control @error('place') is-invalid @enderror" 
                                           id="place" name="place" value="{{ old('place', $job->place) }}" 
                                           placeholder="Thamel">
                                    @error('place')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                            ...
                            <div class="row mb-3">
                                <div class="col-md-4">
                                    ...
                                    <input type="text" class="form-control @error('landmark') is-invalid @enderror" 
                                           id="landmark" name="landmark" value="{{ old('landmark', $job->landmark) }}" 
                                ...
                                <div class="col-md-4">
                                    ...
                                    <input type="text" class="form-control @error('ward_no') is-invalid @enderror" 
                                           id="ward_no" name="ward_no" value="{{ old('ward_no', $job->ward_no) }}" 
                                           placeholder="5">
                                    @error('ward_no')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                ...
                                <div class="col-md-4">
                                    ...
                                    <input type="text" class="form-control @error('postal_code') is-invalid @enderror" 
                                           id="postal_code" name="postal_code" value="{{ old('postal_code', $job->postal_code) }}" 
                                           placeholder="44600">
                                    @error('postal_code')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                            ...
                            <div class="row mb-3">
                                <div class="col-md-6">
                                    ...
                                    <select class="form-select @error('teaching_mode') is-invalid @enderror" 
                                        ...
                                        <option value="home" {{ old('teaching_mode', $job->teaching_mode) === 'home' ? 'selected' : '' }}>Home Tuition</option>
                                        <option value="online" {{ old('teaching_mode', $job->teaching_mode) === 'online' ? 'selected' : '' }}>Online Classes</option>
                                        <option value="institute" {{ old('teaching_mode', $job->teaching_mode) === 'institute' ? 'selected' : '' }}>Institute Classes</option>
                                        <option value="any" {{ old('teaching_mode', $job->teaching_mode) === 'any' ? 'selected' : '' }}>Flexible Location</option>
                                    </select>
                                    @error('teaching_mode')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                ...
                                <div class="col-md-6">
                                    ...
                                    <select class="form-select @error('gender_preference') is-invalid @enderror" 
                                        ...
                                        <option value="male" {{ old('gender_preference', $job->gender_preference) === 'male' ? 'selected' : '' }}>Male Students Only</option>
                                        <option value="female" {{ old('gender_preference', $job->gender_preference) === 'female' ? 'selected' : '' }}>Female Students Only</option>
                                        <option value="any" {{ old('gender_preference', $job->gender_preference) === 'any' ? 'selected' : '' }}>Any Gender</option>
                                    </select>
                            ...
                            <div class="row mb-3">
                                <div class="col-md-6">
                                    ...
                                    <input type="text" class="form-control @error('student_level') is-invalid @enderror" 
                                           id="student_level" name="student_level" value="{{ old('student_level', $job->student_level) }}" 
                                ...
                                <div class="col-md-6">
                                    ...
                                    <select class="form-select @error('session_type') is-invalid @enderror" 
                                        ...
                                        <option value="individual" {{ old('session_type', $job->session_type) === 'individual' ? 'selected' : '' }}>Individual Only</option>
                                        <option value="group" {{ old('session_type', $job->session_type) === 'group' ? 'selected' : '' }}>Group Only</option>
                                        <option value="both" {{ old('session_type', $job->session_type) === 'both' ? 'selected' : '' }}>Both Individual & Group</option>
                                    </select>
                                    @error('session_type')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                            ...
                            <div class="row mb-3">
                                <div class="col-md-4">
                                    ...
                                    <input type="number" class="form-control @error('max_students') is-invalid @enderror" 
                                           id="max_students" name="max_students" value="{{ old('max_students', $job->max_students) }}" 
                                           min="1" max="50">
                                    @error('max_students')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                            ...
                            <div class="row mb-3">
                                <div class="col-12">
                                    ...
                                    <textarea class="form-control @error('requirements') is-invalid @enderror" 
                                              ...
                                              placeholder="Any special requirements or expectations from students...">{{ old('requirements', $job->requirements) }}</textarea>
                                    @error('requirements')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            @if($job->gallery && count($job->gallery) > 0)
                                <div class="row mb-3">
                                    <div class="col-12">
                                        ...
                                        <small class="form-text text-muted">Upload new images below to replace current gallery</small>
                                    </div>
                                </div>
                            @endif
                            ...
                            <div class="row mb-3">
                                <div class="col-12">
                                    <label for="gallery" class="form-label">New Gallery Images (Optional)</label>
                                    <input type="file" class="form-control @error('gallery') is-invalid @enderror" 
                                           id="gallery" name="gallery[]" multiple accept="image/*">
                                    <small class="form-text text-muted">Upload up to 5 images. This will replace existing gallery if uploaded.</small>
                                    @error('gallery')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-4 mb-2">
                                            <div class="form-check">
                                                <input class="form-check-input" type="checkbox" name="preferred_times[]" 
                                                       value="morning" id="time_morning"
                                                       {{ in_array('morning', old('preferred_times', $job->preferred_times ?? [])) ? 'checked' : '' }}>
                                        ...
                                        <div class="col-md-4 mb-2">
                                            <div class="form-check">
                                                <input class="form-check-input" type="checkbox" name="preferred_times[]" 
                                                       value="afternoon" id="time_afternoon"
                                                       {{ in_array('afternoon', old('preferred_times', $job->preferred_times ?? [])) ? 'checked' : '' }}>
                                        ...
                                        <div class="col-md-4 mb-2">
                                            <div class="form-check">
                                                <input class="form-check-input" type="checkbox" name="preferred_times[]" 
                                                       value="evening" id="time_evening"
                                                       {{ in_array('evening', old('preferred_times', $job->preferred_times ?? [])) ? 'checked' : '' }}>
                            ...
                            <div class="d-flex justify-content-between mt-4">
                                <a href="{{ route('tutor.jobs.show', $job) }}" class="btn btn-secondary">
