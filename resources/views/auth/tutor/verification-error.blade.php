...
<div class="py-5 min-vh-100 d-flex align-items-center justify-content-center" style="background: linear-gradient(135deg, #6d86f6ff 0%, #6d86f6ff 100%);">
    <div class="row w-100 shadow-lg rounded-4 overflow-hidden bg-white" style="max-width: 700px;">
        ...
        <div class="col-12 p-5 d-flex flex-column justify-content-center text-center">
            ...
            <p class="text-muted mb-4">The verification link you clicked is invalid or has expired. Please log in to your tutor account to request a new verification email.</p>

            <div class="d-grid gap-2 mb-4">
                <a href="/tutor/login" class="btn bg-orange-500 btn-lg shadow-sm">
            ...
            <div class="text-center">
                ...
                <a href="/tutor/register" class="text-orange-500 text-decoration-none">
                    <i class="fa-solid fa-user-plus me-2"></i>Create New Tutor Account
                </a>
            </div>
        </div>
    </div>
