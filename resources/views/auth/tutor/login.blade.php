    ...
    <div class="row w-100 shadow-lg rounded-4 overflow-hidden bg-white">
        ...
        <div class="col-lg-5 d-flex flex-column justify-content-center align-items-center px-4 py-5">
            <div class="w-100" style="max-width: 400px;">
                <h2 class="fw-bold text-primary mb-4 text-center">Tutor Login</h2>
                ...
                <form method="POST" action="/tutor/login" class="mt-3">
                    @csrf
                    <div class="mb-3">
                ...
                <div class="text-center mt-4">
                    <a href="/tutor/register" class="text-decoration-none text-primary fw-medium fs-5">Don't have an account? Register</a>
                </div>
