                        ...
                        <div class="card-body profile-card-body">
                            ...
                            <div class="row">
                                <div class="col-md-4 text-center mb-4 d-flex flex-column align-items-center">
                                    <div class="profile-avatar mb-3 d-flex justify-content-center">
                                        @if($student->profile_picture)
                                            <img src="{{ asset('storage/' . $student->profile_picture) }}"
                                                alt="{{ $student->name }}"
                                                style="width:140px; height:140px; object-fit:cover; border-radius:50%; border:4px solid #111111; box-shadow:0 6px 25px rgba(0,0,0,0.7);" />
                                        @else
                                            <div
                                                style="width:140px; height:140px; margin:0 auto; display:flex; align-items:center; justify-content:center; background:linear-gradient(135deg, #000000, #111111); border-radius:50%; border:4px solid #111111; box-shadow:0 6px 25px rgba(0,0,0,0.7);">
                                    ...
                                    <div class="mt-2">
                                        ...
                                        @else
                                            <span class="badge bg-secondary unverified-badge" id="unverifiedBadge"
                                    ...
                                    @if($student->bio)
                                        <p class="mt-3 text-center" style="color:#d1d1d1; font-weight:500; max-width:240px;">
                                            {{ $student->bio }}</p>
                                    @endif
                                    ...
                                    <div class="profile-info">
                                        ...
                                        <div class="info-group mb-3">
                                            ...
                                            <div class="info-value">
                                                {{ ($student->location_district ? $student->location_district . ', ' : '') . ($student->location_place ? $student->location_place . ', ' : '') . ($student->location_landmark ? $student->location_landmark : '') ?: 'Not specified' }}
                                            </div>
                                        </div>
                            ...
                            <div class="d-flex gap-2 flex-wrap">
                                ...
                                <a href="{{ route('student.profile.change-password') }}"
                                    class="btn btn-outline-dark-secondary">
                                ...
                                <div class="col-md-3 col-6 mb-3">
                                    <div class="stat-item">
                                        <div class="stat-number text-warning">
                                            {{ $student->vacancies()->pending()->count() }}</div>
                                ...
                                <div class="col-md-3 col-6 mb-3">
                                    <div class="stat-item">
                                        <div class="stat-number text-success">
                                            {{ $student->vacancies()->approved()->count() }}</div>
                                ...
                                <div class="col-md-3 col-6 mb-3">
                                    <div class="stat-item">
                                        <div class="stat-number text-danger">
                                            {{ $student->vacancies()->rejected()->count() }}</div>
            ...
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content" style="background:#121212; color:#e6e6e6; border:1px solid #2a2a2a;">
                    ...
                    <div class="modal-body">
                        To get the Verified badge you must complete at least 80% of your profile. Complete your profile to
                        unlock the verified badge and increase trust.
                    </div>
